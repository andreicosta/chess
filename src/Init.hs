...
starting (2,j) = Place (Just (Piece Pawn Black (8+j)))

starting (8,8) = Place (Just (Piece Rook White 20))
starting (8,1) = Place (Just (Piece Rook White 21))
starting (8,2) = Place (Just (Piece Knight White 22))
starting (8,7) = Place (Just (Piece Knight White 23))
starting (8,3) = Place (Just (Piece Bishop White 24))
starting (8,6) = Place (Just (Piece Bishop White 25))
starting (8,4) = Place (Just (Piece King White 26))
starting (8,5) = Place (Just (Piece Queen White 27))
starting (7,j) = Place (Just (Piece Pawn White (27+j)))
